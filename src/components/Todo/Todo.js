      ...
      <div>
        ...
        <div className="sorting">
          <ul>
            ...
            <li>
              {/* <button onClick={()=>this.sortByDone(true)}>Sort by Done</button> */}
              <Button
              buttonName="Sort by Done"
              handleClickFunction={()=>this.sortByDone(true)}
              />
            </li>
            <li>
              {/* <button onClick={()=>this.sortByDone(false)}>Sort by Not Done</button> */}
              <Button
              buttonName="Sort by Not Done"
              handleClickFunction={()=>this.sortByDone(false)}
              />
            </li>
          </ul>
        </div>{" "}
